      ...
      <section className="section-services">
        ...
        {Object.keys(groupedServices).map((category, index) => (
          <div key={index} className="category-section my-6 ">
            <h2 className="text-lg text-center md:text-xl lg:px-4 text-white lg:text-2xl font-semibold mb-4 capitalize mx-auto p-4 w-max">
              {category}
            </h2>
            ...
            <div className="relative">
              <div
                className="border-[1.5px] absolute border-black top-[-22vh] lg:top-[-22vh] md:top-[-14vh]  right-[0vw] md:h-[5vw] md:w-[5vw] lg:h-[5vw] lg:w-[5vw] h-[10vw] w-[10vw] rounded-full flex items-center justify-center transform -translate-x-1/2 -translate-y-1/2 md:border-white lg:border-white"
              >
                <Link
